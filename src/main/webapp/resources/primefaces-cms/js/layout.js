...
/** 
 * PrimeFaces Cms Layout
 */
var Cms = {
    init: function () {
        this.menuWrapper = $('#layout-menu-cover');
        this.menu = this.menuWrapper.find('ul.cms-menu');
    ...
    saveMenuState: function () {
        $.cookie('cms_expandeditems', this.expandedMenuitems.join(','), {path: '/'});
    },
    clearMenuState: function () {
        $.removeCookie('cms_expandeditems', {path: '/'});
    },
    restoreMenuState: function () {
        var menucookie = $.cookie('cms_expandeditems');
        if (menucookie) {
